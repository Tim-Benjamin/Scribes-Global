        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    <!-- Header -->
                    <tr>
                        <td style="background: linear-gradient(135deg, #D4AF37 0%, #F2D97A 100%); padding: 40px 30px; text-align: center;">
                            <h1 style="color: #1a1a2e; margin: 0; font-size: 32px;">⏰</h1>
                            <h2 style="color: #1a1a2e; margin: 10px 0 0 0; font-size: 24px;">Event Reminder - Tomorrow!</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #666666; line-height: 1.6; margin: 0 0 30px 0; font-size: 16px;">
                                Just a friendly reminder that this event is happening <strong>tomorrow</strong>! We're excited to see you there.
                            </p>
                            
                            <!-- Event Details Box -->
                            <div style="background: linear-gradient(135deg, #fff7ed 0%, #ffedd5 100%); border-radius: 10px; padding: 25px; margin: 0 0 30px 0; border: 2px solid #D4AF37;">
                                ...
                                <table width="100%" cellpadding="8" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="color: #1a1a2e; font-size: 15px; font-weight: bold;">
                                            <?= $event_date ?> (Tomorrow!)
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <h3 style="color: #1a1a2e; margin: 30px 0 15px 0; font-size: 18px;">
                                📝 Things to Remember:
                            </h3>
                            
                            <ul style="color: #666666; line-height: 1.8; font-size: 15px; margin: 0 0 30px 20px;">
                                <li>Arrive 15 minutes early</li>
                                <li>Bring your confirmation (this email)</li>
                                <li>Dress code: Casual and comfortable</li>
                                <li>Feel free to bring a friend!</li>
                            </ul>
