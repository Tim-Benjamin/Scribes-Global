...
.hero-scanlines {
  position: absolute;
  inset: 0;
  background-image: radial-gradient(rgba(9,37,115,0.06) 1px, transparent 1px);
...
.section-wrapper.dark { background: var(--white); }
.section-wrapper.darker { background: var(--off-white); }
.section-wrapper.blue-tint { background: var(--blue-light); }
...
@media (min-width: 768px) { .video-card { flex: 0 0 400px; } }
@media (min-width: 1024px) { .video-card { flex: 0 0 460px; } }
...
.video-meta i { color: var(--royal-blue); font-size: 0.7rem; }
...
@media (min-width: 768px) { .event-card { flex: 0 0 380px; } }
...
@media (min-width: 768px) { .blog-card { flex: 0 0 360px; } }
...
.blog-body h3 a:hover { color: var(--royal-blue); }
...
.blog-stats i { color: var(--royal-blue); font-size: 0.65rem; }
...
.parallax-divider {
  ...
  z-index: 1;
  height: 1px;
  background: linear-gradient(90deg, transparent, rgba(9, 37, 115, 0.12), transparent);
  margin: 0;
}
...
@keyframes glitch1 {
  ...
  20% { clip-path: inset(30% 0 58% 0); transform: translate(2px, 0); }
  40% { clip-path: inset(60% 0 28% 0); transform: translate(-1px, 0); }
}
...
<section class="hero-section">
  ...
  <div class="hero-video-wrap">
    <!-- 
      INSTRUCTIONS: Replace the src below with your actual video URL.
      For YouTube embeds use a direct MP4 link, or host your own video file.
      You can also use a free stock video from Pexels/Pixabay (e.g. worship/arts footage).
      
      Example fallback uses a dark gradient overlay so even without video it looks great.
    -->
    <video 
      autoplay 
      muted 
      loop 
      playsinline
      poster="<?= ASSETS_PATH ?>images/hero-poster.jpg"
    >
  ...
  <!-- <div class="hero-content">
    <div class="hero-eyebrow">Creative Arts Ministry</div>

    <h1 class="hero-title">
      Spreading The Gospel Through<br>
      <span class="gold">Creative Expression</span>
    </h1>
    ...
    <div class="hero-cta">
      <a href="<?= SITE_URL ?>/pages/connect/volunteer" class="btn-primary-gold">
        <i class="fas fa-hands-helping"></i> Join Us Today
      </a>
      <a href="<?= SITE_URL ?>/pages/about/scribes-global" class="btn-ghost">
    ...
    <div class="hero-stats">
      <div class="stat-item">
        <span class="stat-number" data-count="<?= $stats['total_members'] ?? 0 ?>"><?= number_format($stats['total_members'] ?? 0) ?>+</span>
        <span class="stat-label">Active Members</span>
      </div>
      <div class="stat-item">
        <span class="stat-number" data-count="<?= $stats['total_events'] ?? 0 ?>"><?= number_format($stats['total_events'] ?? 0) ?>+</span>
        <span class="stat-label">Events Hosted</span>
      </div>
      <div class="stat-item">
        <span class="stat-number" data-count="<?= $stats['total_chapters'] ?? 0 ?>"><?= number_format($stats['total_chapters'] ?? 0) ?>+</span>
        <span class="stat-label">Global Chapters</span>
      </div>
      <div class="stat-item">
        <span class="stat-number" data-count="<?= $stats['total_content'] ?? 0 ?>"><?= number_format($stats['total_content'] ?? 0) ?>+</span>
...
<section class="section-wrapper dark" id="videos-section">
  <div class="container">
    <div class="section-header-row reveal">
      ...
      <div style="display:flex;flex-direction:column;align-items:flex-end;gap:1rem;">
        ...
        <div class="scroll-nav">
          <button class="scroll-btn" onclick="scrollTrack('video-track', -1)"><i class="fas fa-chevron-left"></i></button>
          <button class="scroll-btn" onclick="scrollTrack('video-track', 1)"><i class="fas fa-chevron-right"></i></button>
        </div>
      </div>
    </div>

    <div class="h-scroll-outer">
      <div class="h-scroll-track" id="video-track">
        <!-- Video Card 1 -->
        <div class="video-card" data-video-id="dQw4w9WgXcQ">
          <div class="video-thumb">
            <img src="https://img.youtube.com/vi/dQw4w9WgXcQ/maxresdefault.jpg" alt="Video" loading="lazy">
            <div class="video-thumb-overlay"></div>
            <div class="play-btn"><i class="fas fa-play"></i></div>
            <div class="video-duration">4:32</div>
          </div>
          <div class="video-body">
            <h3>Powerful Spoken Word Performance</h3>
        ...
        <div class="video-card" data-video-id="dQw4w9WgXcQ">
          <div class="video-thumb">
            <img src="https://img.youtube.com/vi/dQw4w9WgXcQ/mqdefault.jpg" alt="Video" loading="lazy">
            <div class="video-thumb-overlay"></div>
            <div class="play-btn"><i class="fas fa-play"></i></div>
            <div class="video-duration">8:14</div>
          </div>
          <div class="video-body">
            <h3>Worship Night Highlights</h3>
            <div class="video-meta">
        ...
        <div class="video-card" data-video-id="dQw4w9WgXcQ">
          ...
          <div class="video-body">
            <h3>Testimony: How God Changed My Life</h3>
            <div class="video-meta">
        ...
        <div class="video-card" data-video-id="dQw4w9WgXcQ">
          ...
          <div class="video-body">
            <h3>Community Open Mic Night Recap</h3>
            <div class="video-meta">
    ...
    <div class="scroll-dots" id="video-dots"></div>
  </div>
</section>
  ...
  <div class="container">
    <div class="section-header-row reveal">
      ...
      <div style="display:flex;flex-direction:column;align-items:flex-end;gap:1rem;">
        ...
        <div class="scroll-nav">
          <button class="scroll-btn" onclick="scrollTrack('event-track', -1)"><i class="fas fa-chevron-left"></i></button>
          <button class="scroll-btn" onclick="scrollTrack('event-track', 1)"><i class="fas fa-chevron-right"></i></button>
        </div>
      </div>
    </div>
    ...
    <div class="h-scroll-outer">
      <div class="h-scroll-track" id="event-track">
        ...
        <?php else: ?>
          ...
          <?php for ($i = 0; $i < 4; $i++): ?>
          <div class="event-card">
            <div class="event-img-wrap" style="background: var(--blue-light); display:flex; align-items:center; justify-content:center; height:220px;">
              <i class="fas fa-calendar-star" style="font-size:3rem; color: rgba(9,37,115,0.2);"></i>
            </div>
            <div class="event-body">
              <h3>Coming Soon</h3>
              <p>Exciting events are being planned. Check back soon for updates on upcoming gatherings and workshops.</p>
  ...
  <div class="container">
    <div class="section-header-row reveal">
      ...
      <div style="display:flex;flex-direction:column;align-items:flex-end;gap:1rem;">
        ...
        <div class="scroll-nav">
          <button class="scroll-btn" onclick="scrollTrack('blog-track', -1)"><i class="fas fa-chevron-left"></i></button>
          <button class="scroll-btn" onclick="scrollTrack('blog-track', 1)"><i class="fas fa-chevron-right"></i></button>
        </div>
      </div>
    </div>
    ...
    <div class="h-scroll-outer">
      <div class="h-scroll-track" id="blog-track">
          ...
          <?php foreach ($blogPosts as $post): ?>
            <div class="blog-card">
              <div class="blog-img-wrap">
                <img 
                  src="<?= $post['featured_image'] ? ASSETS_PATH . 'images/uploads/' . $post['featured_image'] : ASSETS_PATH . 'images/placeholder-blog.jpg' ?>" 
              ...
              <div class="blog-body">
                ...
                <p class="blog-excerpt"><?= htmlspecialchars(substr(strip_tags($post['content']), 0, 120)) ?>...</p>
                <div class="blog-foot">
                  <div class="blog-author">
                    <?php if ($post['profile_photo']): ?>
                      <img class="blog-author-avatar" src="<?= ASSETS_PATH ?>images/uploads/<?= $post['profile_photo'] ?>" alt="">
                    <?php else: ?>
                      <div class="blog-author-avatar"><?= strtoupper(substr($post['first_name'], 0, 1)) ?></div>
                    <?php endif; ?>
        ...
        <?php else: ?>
          <?php for ($i = 0; $i < 4; $i++): ?>
          <div class="blog-card">
            <div class="blog-img-wrap" style="background: var(--blue-light); height:200px; display:flex; align-items:center; justify-content:center;">
              <i class="fas fa-pen-nib" style="font-size:2.5rem; color: rgba(9,37,115,0.2);"></i>
            </div>
            <div class="blog-body">
              <h3><a href="#">Coming Soon</a></h3>
              <p class="blog-excerpt">Blog posts from our community are coming. Stay tuned for inspiring stories, devotionals, and insights.</p>
              <div class="blog-foot">
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="testimonial-card">
            <p class="testimonial-quote">Scribes Global has transformed my life. I've found a community that encourages me to use my creative gifts for God's glory. The support and mentorship I've received here is invaluable.</p>
            <div class="testimonial-author">
              <img src="<?= ASSETS_PATH ?>images/testimonials/person1.jpg" alt="Sarah Mensah" onerror="this.style.display='none'">
              <div>
                <h5>Sarah Mensah</h5>
        ...
        <div class="swiper-slide">
          <div class="testimonial-card">
            <p class="testimonial-quote">Being part of Scribes Worship has helped me grow both as a musician and as a worshipper. The level of excellence and passion for God here is truly inspiring.</p>
            <div class="testimonial-author">
              <img src="<?= ASSETS_PATH ?>images/testimonials/person2.jpg" alt="David Osei" onerror="this.style.display='none'">
              <div>
                <h5>David Osei</h5>
                <p>Worship Leader</p>
              </div>
        ...
        <div class="swiper-slide">
          <div class="testimonial-card">
            <p class="testimonial-quote">The prayer wall feature has been such a blessing. Knowing that my brothers and sisters in Christ are praying for me during difficult times has strengthened my faith immensely.</p>
            <div class="testimonial-author">
              <img src="<?= ASSETS_PATH ?>images/testimonials/person3.jpg" alt="Grace Addo" onerror="this.style.display='none'">
              <div>
                <h5>Grace Addo</h5>
...
(function() {
  ...
  // Color palette — very subtle for white background
  const ROYAL_BLUE  = new THREE.Color('#092573');
  const MID_BLUE    = new THREE.Color('#1A3FA8');
  const LIGHT_BLUE  = new THREE.Color('#3D5FC4');
  const PALE_BLUE   = new THREE.Color('#8BA4E8');
  ...
  for (let i = 0; i < particleCount; i++) {
    ...
    const t = Math.random();
    let c;
    if (t < 0.25)      c = ROYAL_BLUE;
    else if (t < 0.55) c = MID_BLUE;
    else if (t < 0.80) c = LIGHT_BLUE;
    else               c = PALE_BLUE;
  ...
  function makeMesh(geo, color, x, y, z, opacity = 0.08) {
  ...
  // Icosahedrons
  makeMesh(new THREE.IcosahedronGeometry(5, 1),   0x092573, -20, 10, -10, 0.05);
  makeMesh(new THREE.IcosahedronGeometry(3, 0),   0x1A3FA8,  18, -8,  -5, 0.06);
  makeMesh(new THREE.IcosahedronGeometry(4, 1),   0x3D5FC4,   0, -14, -15, 0.04);

  // Torus knots
  makeMesh(new THREE.TorusKnotGeometry(4, 0.8, 80, 12), 0x092573, 15, 8, -20, 0.04);
  makeMesh(new THREE.TorusKnotGeometry(3, 0.6, 60, 10), 0x1A3FA8, -16, -12, -18, 0.03);

  // Octahedrons
  makeMesh(new THREE.OctahedronGeometry(4, 0),    0x3D5FC4,  10, -5, -8, 0.05);
  makeMesh(new THREE.OctahedronGeometry(2.5, 0),  0x092573, -8,  12, -6, 0.05);
  ...
  // --- GSAP SCROLL ANIMATIONS ON SHAPES ---
  ...
  shapes.forEach((mesh, i) => {
    gsap.to(mesh.rotation, {
      ...
      x: (i % 2 === 0 ? 1 : -1) * Math.PI * 2,
      y: (i % 3 === 0 ? 1 : -1) * Math.PI * 3,
      ease: 'none',
    });
  ...
  function animate() {
    ...
    particles.rotation.y = elapsed * 0.015 + scrollFraction * 1.5;
    particles.rotation.x = elapsed * 0.008 + scrollFraction * 0.5;
    ...
    shapes.forEach((mesh, i) => {
      ...
      mesh.rotation.y += 0.003 * (i % 3 === 0 ? 1 : -1);
    });
