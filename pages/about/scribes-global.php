...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,600;0,700;1,300;1,400;1,600&family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600&family=Caveat:wght@500;600;700&family=Poppins:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
...
<body style="font-family:'Poppins',sans-serif;background:#FAF7F2;color:#1A1A2E;overflow-x:hidden;">
  ...
  ══════════════════════════════════ -->
    <section class="hero-section text-center">
        ...
        <div class="ink-drop"
            style="width:300px;height:300px;bottom:-40px;left:-50px;animation-delay:2.5s;background:radial-gradient(circle,rgba(45,156,219,0.16) 0%,transparent 70%);">
        </div>
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4">
            ...
            <div class="mb-7" data-aos="fade-down">
                <span class="id-pill"
                    style="background:rgba(212,175,55,0.15);border:1px solid rgba(212,175,55,0.4);color:#F2D97A;">
                    <i class="fas fa-calendar-alt text-xs"></i> Established 22nd May, 2017
                </span>
            </div>

            <!-- Headline -->
            <h1 id="hero-headline" class="text-white mb-4" style="font-size:clamp(3.4rem,9vw,6rem);line-height:1.05;">
                Scribes Global

            </h1>

            <!-- Acronym -->
            <p class="text-gold mb-8 font-semibold tracking-wide"
                style="font-size:clamp(1.1rem,2.8vw,1.55rem);font-family:var(--font-body);" data-aos="fade-up"
                data-aos-delay="200">
            ...
            <div class="flex flex-wrap justify-center gap-3 mb-10" data-aos="fade-up" data-aos-delay="320">
                <span class="id-pill"
                    style="background:rgba(107, 70, 193, 0.16);border:1px solid rgba(155,126,222,0.45);color:#C4B5FD;">
                    <i class="fas fa-book-open text-xs"></i> Restorers of Truth
                </span>
                <span class="id-pill"
                    style="background:rgba(212, 175, 55, 0.18);border:1px solid rgba(212,175,55,0.45);color:#F2D97A;">
                    <i class="fas fa-microphone text-xs"></i> Unashamed to Speak
                </span>
                <span class="id-pill"
                    style="background:rgba(45, 155, 219, 0.12);border:1px solid rgba(86,204,242,0.45);color:#7DD3FC;">
        ...
        <div class="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 opacity-40">
            <span class="text-white text-xs tracking-widest uppercase"
                style="font-family:'Poppins',sans-serif;">Scroll</span>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid lg:grid-cols-2 gap-14 items-center">
                ...
                <div class="img-frame" style="height:520px;" data-aos="fade-right" data-aos-duration="900">
                    <img src="https://static.wixstatic.com/media/521bf8_7d622c1e53064c06ab56a08a6e19e1fa~mv2.jpg/v1/fill/w_940,h_600,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/_MG_3829.jpg"
                ...
                <div data-aos="fade-left" data-aos-duration="900" data-aos-delay="100">
                    ...
                    <div class="space-y-4 text-gray-600 font-body font-light text-base leading-relaxed mb-8">
                        <p>Scribes Global is a <strong class="text-ink font-semibold">non-profit, non-denominational
                                organization</strong> set up as an evangelistic ministry to preach the gospel through
                            creative arts — poetry, music, and spoken word.</p>
                        <p>Established on <strong class="text-ink font-semibold">22nd May, 2017</strong>, we have grown
                            from a group of <strong class="text-ink font-semibold">8 members</strong> to over <strong
                                class="text-ink font-semibold">100 members</strong> in different parts of the world,
                            organising events, workshops, conferences and outreach programs.</p>
                        <p>Scribes Global now has chapters in <strong class="text-ink font-semibold">KNUST, University
                                of Cape Coast and University of Ghana</strong> with a global audience to its events and
                            fellowship meetings.</p>
                        <p>As a community of creatives, our ministries are commissioned to preach Jesus Christ and
                            inspire hope for purity and holiness. They include <strong
                                class="text-ink font-semibold">Scribes Poetry, Scribes Worship and Scribes
                                Kids</strong>.</p>
                    </div>
            ...
            <div class="grid lg:grid-cols-2 gap-14 items-center">
                ...
                <div data-aos="fade-right" data-aos-duration="900">
                    ...
                    <div class="space-y-5 text-gray-300 font-body font-light text-base leading-relaxed">
                        <p>Josiah, King of Jerusalem, sent <strong class="text-white font-semibold">Shaphan, a
                                Scribe</strong>, to the high priest — who gave him the Book of the Law. Shaphan read it,
                            saw God's impending wrath, and immediately brought the message to the king. It led to the
                            <strong class="text-gold font-semibold">deliverance of Jerusalem</strong>.
                        </p>
                        <p>We believe like Shaphan, we have been called as Scribes — <strong
                                class="text-white font-semibold">messengers</strong> — to bring the message of <strong
                                class="text-gold font-semibold">REDEMPTION</strong> through our gifts and talents in
                            poetry, music and spoken word to the world.</p>
                    </div>
                ...
                <div class="img-frame" style="height:460px;" data-aos="fade-left" data-aos-duration="900"
                    data-aos-delay="150">
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end p-6 gap-3"
                        ...
                        <span
                            class="inline-flex items-center gap-2 self-start px-4 py-2 rounded-full font-sans font-semibold text-white text-sm"
            ...
            <div class="grid lg:grid-cols-2 gap-8">
                ...
                <div class="lift-card rounded-3xl overflow-hidden shadow-sm"
                    ...
                    <div class="relative h-52 overflow-hidden"
                        style="background:linear-gradient(135deg,#6B46C1,#4A2F8A);">
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                            ...
                            <p class="font-hand text-gold-light text-sm mt-1 opacity-90">Matthew 28:19–20 · 1 Timothy
                                2:4</p>
                        </div>
                    </div>
                    <div class="p-8 bg-white">
                        <p class="text-gray-600 font-body font-light text-base leading-relaxed mb-5">
                            To propagate the message of <strong class="text-ink font-semibold">REDEMPTION</strong> for
                            all to be saved and be prepared for the coming of our Lord and Savior Jesus Christ through
                            the creative arts — poetry, music, spoken word.
                        </p>
                        <div class="space-y-3">
                            <div class="flex gap-3 items-start p-4 rounded-xl" style="background:#FAF7F2;">
                                <i class="fas fa-sun text-gold mt-1 flex-shrink-0"></i>
                                <p class="text-gray-600 font-body text-sm leading-relaxed">In this increasingly dark
                                    world, we exist to restore light (truth) through the preaching of the Gospel, that
                                    men will be redeemed from sin, self and the systems of the world.</p>
                            </div>
                            <div class="flex gap-3 items-start p-4 rounded-xl" style="background:#FAF7F2;">
                                <i class="fas fa-cross text-purple mt-1 flex-shrink-0"></i>
                                <p class="text-gray-600 font-body text-sm leading-relaxed">"Our Lord and Saviour Jesus
                                    Christ is coming again! The church must prepare, souls must be saved!" <strong
                                        class="text-ink">THIS IS OUR MESSAGE!</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lift-card rounded-3xl overflow-hidden shadow-sm"
                    ...
                    <div class="relative h-52 overflow-hidden"
                        style="background:linear-gradient(135deg,#A8871A,#D4AF37);">
                    ...
                    <div class="p-8 bg-white">
                        <p class="text-gray-600 font-body font-light text-base leading-relaxed mb-4">
                            To become a <strong class="text-ink font-semibold">voice (Isaiah 40:3)</strong>, effectively
                            evangelizing the gospel through discipleship — raising believers to become ministers of
                            redemption, taking the world with the Christ-message through creative arts.
                        </p>
                        <p class="text-gray-600 font-body font-light text-base leading-relaxed">
                            Through training and instruction, we aim to raise all believers to live the fullness of the
                            Christ-life (Galatians 4:19) — becoming an <strong class="text-ink font-semibold">agency of
                                redemption and restoration</strong>, projecting Christ to all men, touching lives and
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="text-center mb-16" data-aos="fade-up">
                ...
                <p class="text-gray-500 font-body font-light text-base mt-4 max-w-xl mx-auto">
                    As a community of creatives, our ministries are commissioned to preach Jesus Christ — the salvation
                    of mankind — and inspire hope for purity and holiness.
                </p>
            ...
            <div class="grid sm:grid-cols-3 gap-8">
                ...
                foreach ($mins as $i => $m): ?>
                <div class="ministry-card bg-white shadow-sm lift-card" data-aos="fade-up"
  ...
  ══════════════════════════════════ -->
    <section class="py-24 px-4 relative overflow-hidden" style="background:#1A1A2E;">
        ...
        <div class="absolute inset-0"
            style="background-image:url('https://static.wixstatic.com/media/98ecda_cce9f04b679046bb80afa0f2b60dac4e~mv2.jpg/v1/fill/w_1505,h_443,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/98ecda_cce9f04b679046bb80afa0f2b60dac4e~mv2.jpg');background-size:cover;background-position:center;opacity:0.2;">
        </div>
        ...
        <div class="max-w-6xl mx-auto relative z-10">
            <div class="text-center mb-16" data-aos="fade-up">
                ...
                <p class="text-gray-400 font-body font-light text-base mt-4 max-w-2xl mx-auto">
                    We have extended our ministry to a number of universities in Ghana. Our campus chapters harbour
                    several young talents, serving as a platform to nurture their gifts and propagate the gospel of
                    Christ.
                </p>
                <div class="gold-line max-w-xs mx-auto mt-6"></div>
            </div>
    ...
    <section class="cta-band py-28 px-4 relative">
        <div class="relative z-10 max-w-2xl mx-auto text-center" data-aos="fade-up">
            ...
            <p class="text-gray-300 font-body font-light text-lg leading-relaxed mb-10 max-w-xl mx-auto">
                Whether you're a poet, musician, or simply someone who loves the Lord — there is a place for you in this
                community. Join us as we take the Christ-message to the world.
            </p>
    ...
    <footer style="background:#16213E;" class="text-gray-400 py-16 px-4">
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                ...
                <div class="md:col-span-1">
                    ...
                    <p class="text-sm font-body font-light leading-relaxed text-gray-500 mb-4">
                        A non-profit, non-denominational evangelistic ministry preaching the gospel through creative
                        arts.
                    </p>
                    <div class="space-y-1 text-sm font-body font-light mb-5">
                        <p><a href="mailto:info@scribesglobal.com"
                                class="hover:text-gold transition-colors">info@scribesglobal.com</a></p>
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="<?= $url ?>" target="_blank" rel="noopener"
                            ...
                            style="background:rgba(255,255,255,0.07);" onmouseover="this.style.background='#6B46C1'"
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm font-body font-light">
                        <li><a href="<?= SITE_URL ?>/pages/about/scribes-global"
                                class="hover:text-gold transition-colors">Scribes Global</a></li>
                        <li><a href="<?= SITE_URL ?>/pages/about/ministries"
                                class="hover:text-gold transition-colors">Ministries</a></li>
                        <li><a href="<?= SITE_URL ?>/pages/about/chapters"
                                class="hover:text-gold transition-colors">Chapters / Campuses</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm font-body font-light">
                        <li><a href="<?= SITE_URL ?>/pages/events" class="hover:text-gold transition-colors">Events</a>
                        </li>
                        <li><a href="<?= SITE_URL ?>/pages/projects/heal"
                                class="hover:text-gold transition-colors">Project H.E.A.L</a></li>
                        <li><a href="<?= SITE_URL ?>/pages/media" class="hover:text-gold transition-colors">Media</a>
                        </li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm font-body font-light">
                        <li><a href="<?= SITE_URL ?>/pages/connect/invite"
                                class="hover:text-gold transition-colors">Invite Scribes Global</a></li>
                        <li><a href="<?= SITE_URL ?>/pages/connect/volunteer"
                                class="hover:text-gold transition-colors">Join / Volunteer</a></li>
                    </ul>
                </div>
            ...
            <div class="border-t pt-8 flex flex-col sm:flex-row justify-between items-center gap-4"
                ...
                <p class="text-xs font-body text-gray-600">&copy;<?= date('Y') ?> by Scribes Global. All rights
                    reserved.</p>
            </div>
        </div>
    </footer>
