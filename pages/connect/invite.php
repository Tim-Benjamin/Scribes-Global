...
@media (max-width: 600px) {
  ...
  .submit-btn { width: 100%; padding: 1rem 2rem; }
}
</style>
  ...
  <div class="booking-container">
    ...
    <div class="booking-card">
      <form class="booking-form" id="bookingForm">
        ...
        <!-- Personal Info -->
        <p class="form-section-label"><i class="fas fa-user" style="margin-right:0.4rem;"></i>Personal Information</p>
        <div class="form-grid">
        ...
        <!-- Event Info -->
        <p class="form-section-label"><i class="fas fa-calendar-star" style="margin-right:0.4rem;"></i>Event Details</p>
        <div class="form-grid">
          <div class="form-group">
        ...
        <!-- Message -->
        <p class="form-section-label"><i class="fas fa-comment-alt" style="margin-right:0.4rem;"></i>Additional Information</p>
        <div class="form-group" style="margin-bottom:0;">
          <label for="message">Message</label>
          <textarea id="message" name="message" placeholder="Tell us more about your event, specific requirements, or any questions you have..."></textarea>
        </div>
